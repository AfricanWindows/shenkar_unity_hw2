...
///
/// The countdown itself is NOT written here - it lives in TimedPlayerEffect, which runs
/// a coroutine (WaitForSeconds). This class only says what "active" means for the speed.
...
public class PlayerSpeedBoost : TimedPlayerEffect
{
    ...
    private void ApplySpeed(bool isActive)
    {
        ...
        movement.speed = isActive ? normalSpeed * (1f + speedBonus) : normalSpeed;
    }
